...
const baseUrl = baseURLChatBotAPI
...
const customFetchBaseChatbot: BaseQueryFn<string | FetchArgs, unknown, FetchBaseQueryError> = async (
  args,
  api,
  extraOptions
) => {
...
export default customFetchBaseChatbot
