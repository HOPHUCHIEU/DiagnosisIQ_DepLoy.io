  ...
  (
    ...
    const handleDaySelect = useCallback(
      (day: Date | undefined) => {
        ...
        // Hàm so sánh ngày không bị ảnh hưởng bởi múi giờ
        ...
        if (mode === 'multiple') {
          const newDates = selectedDates.some((d) => isSameDayNoTimezone(d, normalizedDay))
            ? selectedDates.filter((d) => !isSameDayNoTimezone(d, normalizedDay))
            : [...selectedDates, normalizedDay]
