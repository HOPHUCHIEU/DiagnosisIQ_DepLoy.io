        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Textarea {...field} className='min-h-[100px]' placeholder='Nhập tiểu sử bác sĩ...' />
              </FormControl>
              <FormMessage />
            </FormItem>
          )}
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input {...field} placeholder='Ví dụ: Chứng chỉ chuyên khoa Tim mạch' />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    )}
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input {...field} placeholder='Ví dụ: Bộ Y tế' />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    )}
